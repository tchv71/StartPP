...
enum dbf_charconv
{
   dbf_charconv_oem_host,
   dbf_charconv_off,
   dbf_charconv_enumcount,
   dbf_charconv_compatible = dbf_charconv_oem_host,
   dbf_charconv_default = dbf_charconv_oem_host
};

enum dbf_editmode
{
    dbf_editmode_editable,
    dbf_editmode_readonly
};
...
EXTERN_C DBF_HANDLE  dbf_open          (const char* filePath, const DBF_OPEN*);

EXTERN_C DBF_HANDLE  dbf_create        (const char* filePath, const DBF_CREATE*);
EXTERN_C DBF_HANDLE  dbf_create_attach (void* stream, const DBF_CREATE*, void* memoStream);
