    ...
    : wxDocParentFrame(manager, parent, id, title, pos, size, style)
{
    ...
    m_auibarStandard->AddTool(wxID_RECORD_LAST, wxT("Tool Label"), wxArtProvider::GetBitmap(wxART_GOTO_LAST, wxART_TOOLBAR, wxSize(16, 16)), wxNullBitmap, wxITEM_NORMAL, wxT("Последний"), wxT("Последний участок"), NULL);
