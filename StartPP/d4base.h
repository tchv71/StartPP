...
EXTERN_C int  d4create(const TCHAR*, const struct zlib_filefunc_def_s*, int, const FIELD *, int);
EXTERN_C int  d4use2(const TCHAR* file, const struct zlib_filefunc_def_s*, int readonly);
