...
class DataModelListCtrl : public wxDataViewCtrl
{
    ...
    wxDECLARE_DYNAMIC_CLASS(DataModelListCtrl);
public:
    DataModelListCtrl();
...
class DataModelListCtrlAdaptor : public wxAddRemoveAdaptor
{
public:
    DataModelListCtrlAdaptor(DataModelListCtrl* list = NULL) : m_listCtrl(list)
    {
    }
    void SetItemsCtrl(DataModelListCtrl* list)
    {
        m_listCtrl = list;
    }
    ...
    bool DoAdd();
    bool IsUndeletedInSelection();
    bool IsDeletedInSelection();
    void DeleteSelection(bool bDelete);
    void DeleteAll(bool bDelete);
    bool IsRecordDeleted(unsigned int row);
    bool DeleteRecord(unsigned int row, bool bDelete);
private:
    DataModelListCtrl* m_listCtrl;
};
